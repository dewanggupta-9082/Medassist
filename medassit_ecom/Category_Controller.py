...
def Submit_Category(request):
 try:
    ...
    F=open("C:/users/Asus/medassist_ecom/assets/"+categoryicon.name,'wb')
    ...
    DB.commit()
    DB.close()
    return render(request, 'Category.html',{'message':'Record Submitted'})
 except Exception as e:
     print("Error:",e)
     return render(request, 'Category.html',{'message':'Record not Submitted'})
